  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-3">
        <div className="flex">
          <button className="bg-[#FFFF00] text-black px-6 py-1">
            Get started
          </button>
          <FontAwesomeIcon
            icon={faArrowRight}
            className="absolute ml-[108px] mt-[10px] text-black"
          />
        </div>
        <div className="flex">
          <button className="border border-[#FFFF00] px-6 py-1 text-[#FFFF00]">
            See repo
          </button>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 496 512"
            className="invert w-3 h-3 absolute ml-[90px] mt-[13px] text-[#FFFF00]"
          >
