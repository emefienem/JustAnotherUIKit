  ...
  return (
    <div className="flex flex-col justify-center items-center text-center text-white pb-[100px]">
      ...
      <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mt-5 ">
        <p className="bg-white text-black px-10 py-5">Lorem</p>
        <p className="bg-white text-black px-10 py-5">Ipsum</p>
        <p className="bg-white text-black px-[42px] py-5">Dolor</p>
        <p className="bg-white text-black px-[52px] py-5">Sit</p>
      </div>
      ...
      <h1 className="mt-5 text-center text-xl md:text-2xl">
        Less code. More Product.
      </h1>
      <p className="max-w-[350px] text-[12px] md:text-sm">
